...
const App: React.FC = () => {
  ...
  return (
    <div className="min-h-screen min-h-[100dvh] bg-slate-950 flex flex-col">
        ...
        <div className="px-3 py-2 flex items-center justify-between gap-2">
          ...
          <div className="flex items-center gap-2">
            ...
            <button
              ...
              className="w-8 h-8 flex items-center justify-center rounded-full bg-slate-800 text-slate-400 hover:text-white active:scale-95 transition-all"
              title="Paramètres"
            >
              ⚙️
            </button>
      ...
      {/* === MOBILE BOTTOM NAV === */}
      <nav className="relative z-20 bg-slate-950/95 backdrop-blur-md border-t border-slate-800/50 shrink-0 pb-[env(safe-area-inset-bottom)]">
          ...
          {NAV_ITEMS.map((item) => {
            ...
            return (
              <button
                ...
                className={`relative flex flex-col items-center gap-0.5 px-3 py-2 rounded-xl transition-all active:scale-95 min-w-[56px] ${
                  isActive 
